...
To solve this issue, you need to set the library path, similar to LD_LIBRARY_PATH on other Unix variants, built on OS X you need to do the following (this is for a binary install of MySQL from Oracle)
